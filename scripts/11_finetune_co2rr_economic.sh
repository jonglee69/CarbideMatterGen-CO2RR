...
#   P7 co2rr_selectivity        (CO over H2: ΔG_H − ΔG_COOH -> high)
#   P8 metal_packing_density    (metallic-framework / conductivity proxy)
#   P9 expensive_metal_fraction (economic: PGM + heavy-REE fraction -> 0 at gen)
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT}/outputs/finetune_co2rr_economic}"
export OUTPUT_DIR
...
echo "=============================================================="
echo " CarbideMatterGen — CO2RR economic fine-tune (9-property adapter)"
