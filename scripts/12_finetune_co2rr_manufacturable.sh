...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT}/outputs/finetune_co2rr_mfg}"
export OUTPUT_DIR
...
export CARBIDE_CACHE_ROOT="${CARBIDE_CACHE_ROOT:-${ROOT}/cache/overlay_mfg}"
...
echo "=============================================================="
echo " CarbideMatterGen — CO2RR MANUFACTURABLE fine-tune (9-property adapter)"
