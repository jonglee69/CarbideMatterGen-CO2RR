...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT}/outputs/finetune_co2rr_uma}"
export OUTPUT_DIR
...
export CARBIDE_CACHE_ROOT="${CARBIDE_CACHE_ROOT:-${ROOT}/cache/overlay_uma}"
...
echo "=============================================================="
echo " CarbideMatterGen — CO2RR UMA-LABELLED fine-tune (9-property adapter)"
